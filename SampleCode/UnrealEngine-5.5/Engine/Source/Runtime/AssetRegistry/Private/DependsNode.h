...
public:
	...
	bool ContainsDependency(FDependsNode* InDependency,
		UE::AssetRegistry::EDependencyCategory Category = UE::AssetRegistry::EDependencyCategory::All) const;
...
inline void FDependsNode::Construct()
{
	PackageIsSorted = 1;
