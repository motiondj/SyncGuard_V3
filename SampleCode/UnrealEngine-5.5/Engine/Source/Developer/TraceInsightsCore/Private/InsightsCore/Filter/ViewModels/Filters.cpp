...
#include "InsightsCore/Filter/Widgets/SAdvancedFilter.h"
...
void FFilterService::RegisterTabSpawner()
{
	FTabSpawnerEntry& TabSpawnerEntry = FGlobalTabmanager::Get()->RegisterNomadTabSpawner(FilterConfiguratorTabId,
		...
		.SetIcon(FSlateIcon(FInsightsCoreStyle::GetStyleSetName(), "Icons.ClassicFilterConfig"));
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// FFilterWithSuggestionsValueConverter
////////////////////////////////////////////////////////////////////////////////////////////////////
