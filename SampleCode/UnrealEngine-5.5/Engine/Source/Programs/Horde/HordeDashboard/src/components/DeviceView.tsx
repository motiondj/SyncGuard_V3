      ...
      return <Stack verticalFill={true} verticalAlign="center">
         <Stack horizontal tokens={{ childrenGap: 12 }}>
            {automationTab && <Stack verticalFill={true} verticalAlign="center">
               <TooltipHost content="History" delay={0} closeDelay={250}
                  styles={{root: {display: 'inline-block'}}} directionalHint={DirectionalHint.leftCenter}>
