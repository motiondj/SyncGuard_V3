...
class AuditLogHandler {
   ...
   async update() {
      ...
      if (!this.agentId && !this.issueId && !this.templateAudit && !this.deviceId) {
         return;
      }
...
export const AuditLogPanel: React.FC<{ agentId?: string, deviceId?: string, issueId?: string, templateAudit?: TemplateAudit }> = observer(({ agentId, deviceId, issueId, templateAudit }) => {
   ...
   if (!agentId && !deviceId && !issueId && !templateAudit) {
      return null;
   }
...
export const AuditLogView: React.FC = () => {
   ...
   const { agentId, deviceId, issueId, streamId, templateId } = useParams<{ agentId: string, deviceId: string, issueId: string, streamId: string, templateId: string }>();
