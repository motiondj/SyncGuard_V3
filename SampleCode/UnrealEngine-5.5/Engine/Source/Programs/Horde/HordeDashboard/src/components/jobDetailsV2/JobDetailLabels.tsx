...
export const LabelsPanelV2: React.FC<{ jobDetails: JobDetailsV2, dataView: JobDataView }> = observer(({ jobDetails, dataView }) => {
   ...
   const renderSteps = () => {
            ...
            <Stack horizontal>
               <Link to={stepUrl} onClick={(ev) => { ev.stopPropagation(); }}><div style={{ cursor: "pointer" }}>
                  <Stack horizontal verticalAlign="center">
                     ...
                     <Text styles={{ root: { fontSize: 13, paddingRight: 4, paddingTop: 2, userSelect: "none" } }}>{`${stepItem.name}`}</Text>
                  </Stack>
               </div></Link>
            </Stack>
         </Stack>;
      ...
      return <Stack horizontal wrap tokens={{ childrenGap: 12 }}>{render}</Stack>;
   ...
   return <Stack styles={{ root: { paddingTop: 18, paddingRight: 12 } }}>
      <Stack style={{ paddingLeft: 12 }}>
         ...
         <Stack style={{ paddingTop: 12, paddingLeft: 12 }} horizontal>
            <Stack>
