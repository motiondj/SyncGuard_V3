...
namespace HordeServer.Notifications
{
	...
	public interface INotificationService
	{
		...
		/// <returns></returns>
		Task<bool> UpdateSubscriptionsAsync(NotificationTriggerId triggerId, ClaimsPrincipal user, bool? email, bool? slack, CancellationToken cancellationToken);
		...
		Task<INotificationSubscription?> GetSubscriptionsAsync(NotificationTriggerId triggerId, ClaimsPrincipal user, CancellationToken cancellationToken);
