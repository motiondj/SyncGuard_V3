...
FCustomVersionRegistration GRegisterCustomizableObjectCustomVersion(FRivermaxMediaVersion::GUID, FRivermaxMediaVersion::LatestVersion, TEXT("RivermaxMediaVersion"));
