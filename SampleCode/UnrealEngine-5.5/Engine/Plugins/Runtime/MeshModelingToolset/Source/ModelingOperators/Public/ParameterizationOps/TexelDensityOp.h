...
#include "TexelDensityOp.generated.h"
...
UCLASS()
class MODELINGOPERATORS_API UUVEditorTexelDensitySettings : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
namespace UE
{
	namespace Geometry
	{
		...
		class MODELINGOPERATORS_API FUVEditorTexelDensityOp : public FDynamicMeshOperator
		{
		public:
 ...
 */
UCLASS()
class MODELINGOPERATORS_API UUVTexelDensityOperatorFactory : public UObject, public UE::Geometry::IDynamicMeshOperatorFactory
{
	GENERATED_BODY()
