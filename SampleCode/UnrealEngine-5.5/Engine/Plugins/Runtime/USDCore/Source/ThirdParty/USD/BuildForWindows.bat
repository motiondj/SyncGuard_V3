...
rem     git clone --branch v24.05 https://github.com/PixarAnimationStudios/OpenUSD.git OpenUSD_src
rem Then from inside the cloned OpenUSD_src directory, apply all patches sitting
rem next to this build script:
rem     git apply <build script dir>/OpenUSD_v2405_*.patch
