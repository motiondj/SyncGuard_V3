...
TBB_INCLUDE_LOCATION="$UE_THIRD_PARTY_LOCATION/Intel/TBB/IntelTBB-2019u8/include"
TBB_BINARIES_LOCATION="$UE_ENGINE_LOCATION/Binaries/ThirdParty/Intel/TBB/Mac"
...
CMAKE_ARGS=(
    ...
    -DTBB_LIBRARY="$TBB_BINARIES_LOCATION"
