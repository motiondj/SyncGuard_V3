...
//----------------------------------------------------------------//
struct FStateTreeStateOverrideProvider : public FPropertyBagInstanceDataDetails::IPropertyBagOverrideProvider
{
...
FStateTreeStateParametersInstanceDataDetails::FStateTreeStateParametersInstanceDataDetails(
...
void FStateTreeStateParametersInstanceDataDetails::OnChildRowAdded(IDetailPropertyRow& ChildRow)
{
...
bool FStateTreeStateParametersInstanceDataDetails::HasPropertyOverrides() const
{
	if (const UStateTreeState* State = WeakState.Get())
	{
...
void FStateTreeStateParametersInstanceDataDetails::PreChangeOverrides()
{
	check(StructProperty);
	StructProperty->NotifyPreChange();
}

void FStateTreeStateParametersInstanceDataDetails::PostChangeOverrides()
{
	check(StructProperty);
...
void FStateTreeStateParametersInstanceDataDetails::EnumeratePropertyBags(TSharedPtr<IPropertyHandle> PropertyBagHandle, const EnumeratePropertyBagFuncRef& Func) const
{
