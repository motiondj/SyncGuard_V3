...
void UCustomizableObjectNodeSwitchBase::AllocateDefaultPins(UCustomizableObjectNodeRemapPins* RemapPins)
{
	...
	UEdGraphPin* OutputPin = CustomCreatePin(EGPD_Output, GetCategory(), FName(GetPinCategoryName(GetCategory()).ToString()));
...
{
	return GetPinCategoryName(GetCategory()).ToString() + " ";
}
