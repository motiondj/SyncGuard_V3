...
namespace mu
{
	...
	//---------------------------------------------------------------------------------------------
	FNodeType NodeImageLayerColour::Private::s_type = FNodeType(Node::EType::ImageLayerColour, NodeImage::GetStaticType() );
	...
	MUTABLE_IMPLEMENT_NODE( NodeImageLayerColour );
