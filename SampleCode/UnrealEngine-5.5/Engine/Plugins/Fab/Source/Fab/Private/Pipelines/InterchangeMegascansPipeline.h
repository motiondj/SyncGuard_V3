...
enum class EMegascanMaterialType : int32
{
	...
	Base3D UMETA(DisplayName = "3D"),
	Fuzz3D UMETA(DisplayName="3D with Fuzz"),
	Transmission3D UMETA(DisplayName="3D with Tranmission"),
	Glass3D UMETA(DisplayName="Glass 3D"),

	Surface UMETA(DisplayName = "Surface"),
	TransmissionSurface UMETA(DisplayName="Surface with Tranmission"),
	FabricSurface UMETA(DisplayName="Fabric Surface"),

	Decal UMETA(DisplayName = "Decal"),

	Plant UMETA(DisplayName = "Plant Base"),
