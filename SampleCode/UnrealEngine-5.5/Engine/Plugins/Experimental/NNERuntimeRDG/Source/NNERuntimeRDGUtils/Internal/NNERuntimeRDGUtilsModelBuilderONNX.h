...
NNERUNTIMERDGUTILS_API TUniquePtr<IModelBuilder> CreateONNXModelBuilder(int64 IrVersion, int64 OpsetVersion);

NNERUNTIMERDGUTILS_API bool CreateONNXModelForOperator(const FString& OperatorName, int32 IrVersion, int32 OpsetVersion, bool bUseVariadicShapeForModel,
