...
namespace UE::NNERuntimeRDG::Private::Hlsl
{
	...
	void FillTensorSizeShaderParameters(const NNE::Internal::FTensor& Tensor, TTensorInfoParam& OutTensorInfoParam, int32 Idx)
	{
	...
	template void FillTensorSizeShaderParameters(const NNE::Internal::FTensor&, FTensorInfoParam&, int32);
	template void FillTensorSizeShaderParameters(const NNE::Internal::FTensor&, FTensorInfoParamArraySpan&, int32);
	
	template<typename TTensorInfoParam>
	void FillTensorStrideShaderParameters(const NNE::Internal::FTensor& Tensor, TTensorInfoParam& OutTensorInfoParam, int32 Idx, int32 TargetNumdimensionForBroadcast)
	{
	...
	template void FillTensorStrideShaderParameters(const NNE::Internal::FTensor&, FTensorInfoParam&, int32, int32);
	template void FillTensorStrideShaderParameters(const NNE::Internal::FTensor&, FTensorInfoParamArraySpan&, int32, int32);

	template<typename TTensorInfoParam>
	void FillTensorStrideForBroadcastShaderParameters(const NNE::Internal::FTensor& Tensor, int32 OutputNumdimension, TTensorInfoParam& OutTensorInfoParam, int32 Idx)
	{
	...
	template void FillTensorStrideForBroadcastShaderParameters(const NNE::Internal::FTensor&, int32, FTensorInfoParam&, int32);
	template void FillTensorStrideForBroadcastShaderParameters(const NNE::Internal::FTensor&, int32, FTensorInfoParamArraySpan&, int32);
