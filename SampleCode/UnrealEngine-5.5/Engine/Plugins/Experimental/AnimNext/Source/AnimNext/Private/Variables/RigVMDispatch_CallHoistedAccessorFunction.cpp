...
FRigVMDispatch_CallHoistedAccessorFunction::FRigVMDispatch_CallHoistedAccessorFunction()
{
	FactoryScriptStruct = StaticStruct();
}

FName FRigVMDispatch_CallHoistedAccessorFunction::GetArgumentNameForOperandIndex(int32 InOperandIndex, int32 InTotalOperands) const
{
...
const TArray<FRigVMTemplateArgumentInfo>& FRigVMDispatch_CallHoistedAccessorFunction::GetArgumentInfos() const
{
...
FRigVMTemplateTypeMap FRigVMDispatch_CallHoistedAccessorFunction::OnNewArgumentType(const FName& InArgumentName, TRigVMTypeIndex InTypeIndex) const
{
	const FRigVMRegistry_NoLock& Registry = FRigVMRegistry_NoLock::GetForRead();
...
void FRigVMDispatch_CallHoistedAccessorFunction::Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray RigVMBranches)
{
