...
bool UPCGDataCollectionDataProvider::ProcessReadBackData(FPCGComputeGraphContext* InContext)
{
	...
	const EPCGUnpackDataCollectionResult Result = PinDesc.UnpackDataCollection(InContext, RawReadbackData, OutputPinLabelAlias, InContext->DataBinding->GetStringTable(), DataFromGPU);
